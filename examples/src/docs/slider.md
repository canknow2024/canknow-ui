...
<template>
  ...
  <div class="block">
    ...
    <c-slider v-model="value3" :show-tooltip="false"></c-slider>
  </div>
  <div class="block">
    <span class="demonstration">Format Tooltip</span>
    <c-slider v-model="value4" :format-tooltip="formatTooltip"></c-slider>
  </div>
  <div class="block">
    <span class="demonstration">Disabled</span>
    <c-slider v-model="value5" disabled></c-slider>
  </div>
</template>
...
| input-size | size of the input box | string | large / medium / small / smaller | small |
