...
|size | size of Input | string | large/small/smaller | — |
...
| prefix-icon | Custom prefix icon class | string | — | icon-date |
| clear-icon | Custom clear icon class | string | — | icon-circle-close |
