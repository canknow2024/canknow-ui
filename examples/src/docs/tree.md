...
:::demo
```html
<c-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></c-tree>
...
<div class="buttons">
  <c-button @click="getCheckedNodes">get by node</c-button>
  <c-button @click="getCheckedKeys">get by key</c-button>
  <c-button @click="setCheckedNodes">set by node</c-button>
  <c-button @click="setCheckedKeys">set by key</c-button>
  <c-button @click="resetChecked">reset</c-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <c-button size="small" type="text" on-click={ () => this.append(data) }>Append</c-button>
              <c-button size="small" type="text" on-click={ () => this.remove(node, data) }>Delete</c-button>
            </span>
          </span>);
      }
    }
