...
import { hasClass, addClass, removeClass } from 'canknow-core/src/libs';
import FilterPanel from './TableFilterPanel.vue';
...
export default {
  ...
  render(h) {
    ...
    return (
      <table
        ...
        <thead class={ [{ 'group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="c-table-column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <icon name={ column.filterOpened ? 'up' : 'down' }></icon>
                        </span>) : ''
                      }
                    </div>
                  </th>))
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.c-table-column-filter-trigger') || cell;
