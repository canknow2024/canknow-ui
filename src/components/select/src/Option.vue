<template>
    <li @mouseenter="hoverItem"
        ...
        class="c-select-dropdown-item"
        v-show="visible"
        :class="{ 'selected': itemSelected, 'disabled': disabled || groupDisabled || limitReached, 'hover': hover  }">
        <slot>
...
import { getValueByPath } from 'canknow-core/src/libs';
...
export default {
  ...
  computed: {
    shownLabel() {
      return this.label || this.$el.innerText;
    },
    isObject() {
  ...
  methods: {
    ...
    selectOptionClick() {
      if (this.disabled !== true && this.groupDisabled !== true) {
        this.dispatch('CSelect', 'handleOptionClick', [this, true]);
      }
    },
    queryChange(query) {
