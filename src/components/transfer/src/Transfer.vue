...
export default {
  ...
  render (h) {
    ...
    return h('div', {
      ...
      h(List, {
        ref: 'left',
        props: {
          prefixClass: this.prefixClass + '-list',
          data: this.leftData,
        ...
        on: {
          'checked-keys-change': this.handleLeftCheckedKeysChange
        }
      }, vNodes),
      h('div', {
        class: 'c-transfer-operation-wrap'
      }, [
        h(Operation, {
          props: {
      ...
      h(List, {
        ...
        on: {
          'checked-keys-change': this.handleRightCheckedKeysChange
        }
      }, clonedVNodes)
    ]);
  },
  ...
  computed: {
    ...
    localeFilterPlaceholder () {
      if (this.filterPlaceholder === undefined) {
        return this.t('core.transfer.filterPlaceholder');
      }
      else {
    ...
    localeNotFoundText () {
      if (this.notFoundText === undefined) {
        return this.t('core.transfer.notFoundText');
      }
      else {
    ...
    localeTitles () {
      if (this.titles === undefined) {
        return [this.t('core.transfer.titles.source'), this.t('core.transfer.titles.target')];
      }
      else {
        return this.titles;
      }
  ...
  methods: {
    ...
    handleCheckedKeys () {
      ...
      this.$emit('selected-change', sourceSelectedKeys, targetSelectedKeys);
    }
  },
  watch: {
    targetKeys () {
