      ...
      <div
        ...
        <c-button-group>
          <c-button
            ...
            {{ t('core.datepicker.prevMonth') }}
          </c-button>
          <c-button
              scene="default"
              size="small"
              @click="selectDate('today')">
            {{ t('core.datepicker.today') }}
          </c-button>
          <c-button
              scene="default"
              size="small"
              @click="selectDate('next-month')">
            {{ t('core.datepicker.nextMonth') }}
          </c-button>
        </c-button-group>
      </div>
    </div>
    <div
        class="c-calendar-body"
        v-if="validatedRange.length === 0"
        key="no-range">
      <date-table
          :date="date"
...
export default {
  ...
  computed: {
    ...
    i18nDate() {
      ...
      return `${year} ${this.t('core.datepicker.year')} ${this.t('core.datepicker.month' + month)}`;
    },
