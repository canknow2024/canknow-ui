<template>
  <transition
    ...
    <div
        v-show="visible"
        class="c-time-range-picker c-picker-panel c-popper"
        :class="popperClass">
      <div class="c-time-range-picker-content">
        <div class="c-time-range-picker-cell">
          <div class="c-time-range-picker-header">{{ t('core.datepicker.startTime') }}</div>
          <div
              :class="{ 'has-seconds': showSeconds, 'arrow': arrowControl }"
              class="c-time-range-picker-body time-panel-content">
            <time-spinner
                ref="minSpinner"
        ...
        <div class="c-time-range-picker-cell">
          <div class="c-time-range-picker-header">{{ t('core.datepicker.endTime') }}</div>
          <div
              :class="{ 'has-seconds': showSeconds, 'arrow': arrowControl }"
              class="c-time-range-picker-body c-time-panel-content">
            <time-spinner
                ref="maxSpinner"
                :show-seconds="showSeconds"
                :am-pm-mode="amPmMode"
      ...
      <div class="c-picker-panel-footer">
        <c-button
            ...
            @click="handleCancel()">{{ t('core.datepicker.cancel') }}</c-button>
        <c-button
            plain
            scene="primary"
            class="c-picker-panel-link-button"
            @click="handleConfirm()"
            :disabled="buttonDisabled">{{ t('core.datepicker.confirm') }}</c-button>
      </div>
    </div>
  </transition>
</template>
