<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="c-month-table">
    <tbody>
    <tr v-for="(row, key) in rows" :key="key">
      <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
        <div>
          <a class="cell">{{ t('core.datepicker.months.' + months[cell.text]) }}</a>
        </div>
      </td>
    </tr>
    </tbody>
...
import { hasClass } from 'canknow-core/src/libs';
