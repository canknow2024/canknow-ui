<template>
  <div class="c-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="c-time-spinner-wrapper"
        wrap-style="max-height: inherit;"
        view-class="c-time-spinner-list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="c-time-spinner-wrapper arrow">
        <icon v-repeat-click="decrease" name="up" class="c-time-spinner-arrow arrow-up"></icon>
        <icon v-repeat-click="increase" name="down" class="c-time-spinner-arrow arrow-down"></icon>
        <ul class="c-time-spinner-list" ref="hours">
          <li
            class="c-time-spinner-item"
      ...
      <div
        ...
        <icon v-repeat-click="decrease" name="up" class="c-time-spinner-arrow arrow-up"></icon>
        <icon v-repeat-click="increase" name="down" class="c-time-spinner-arrow arrow-down"></icon>
        <ul class="c-time-spinner-list" ref="minutes">
          <li
            class="c-time-spinner-item"
      ...
      <div
        ...
        <icon v-repeat-click="decrease" name="up" class="c-time-spinner-arrow arrow-up"></icon>
        <icon v-repeat-click="increase" name="down" class="c-time-spinner-arrow arrow-down"></icon>
        <ul class="c-time-spinner-list" ref="seconds">
          <li
